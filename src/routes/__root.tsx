...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CareBridge — Care, Connected" },
      {
        name: "description",
        content:
          "CareBridge connects verified orphanages and old-age homes with donors, volunteers, and mentors.",
      },
      { property: "og:title", content: "CareBridge — Care, Connected" },
      {
        property: "og:description",
        content: "A trusted platform connecting communities with verified care institutions.",
      },
